...
function useWinClick(open, clickToHide, targetEle, popupEle, mask, maskClosable, inPopupOrChild, triggerOpen) {
  ...
  var lockRef = React16.useRef(false);
...
function generateTrigger() {
  ...
  var Trigger = React17.forwardRef(function(props, ref) {
    ...
    var _React$useState13 = React17.useState([0, 0]), _React$useState14 = _slicedToArray(_React$useState13, 2), mousePos = _React$useState14[0], setMousePos = _React$useState14[1];
    ...
    return React17.createElement(React17.Fragment, null, React17.createElement(es_default, {
      ...
      getTriggerDOMNode
    }, triggerNode)), React17.createElement(context_default.Provider, {
      value: context
...
function isFragment(child) {
  return child && isValidElement(child) && child.type === React19.Fragment;
}
function replaceElement(element, replacement, props) {
  if (!isValidElement(element)) {
    return replacement;
  }
  return React19.cloneElement(element, typeof props === "function" ? props(element.props || {}) : props);
}
...
var PurePanel = (props) => {
  ...
  const [wrapSSR, hashId] = style_default(prefixCls, true);
  const colorInfo = parseColor(prefixCls, color);
  const arrowContentStyle = colorInfo.arrowStyle;
  const formattedOverlayInnerStyle = Object.assign(Object.assign({}, overlayInnerStyle), colorInfo.overlayStyle);
  const cls = (0, import_classnames7.default)(hashId, prefixCls, `${prefixCls}-pure`, `${prefixCls}-placement-${placement}`, className, colorInfo.className);
  return wrapSSR(React20.createElement("div", {
    className: cls,
    style: arrowContentStyle
  }, React20.createElement("div", {
    className: `${prefixCls}-arrow`
  }), React20.createElement(Popup, Object.assign({}, props, {
    className: hashId,
    prefixCls,
...
var Tooltip3 = React21.forwardRef((props, ref) => {
  var _a, _b;
  const {
    prefixCls: customizePrefixCls,
    openClassName,
  ...
  const tooltipPlacements = React21.useMemo(() => {
    var _a2, _b2;
  ...
  const memoOverlay = React21.useMemo(() => {
    if (title === 0) {
      return title;
    }
    return overlay || title || "";
  }, [overlay, title]);
  const memoOverlayWrapper = React21.createElement(NoCompactStyle, null, typeof memoOverlay === "function" ? memoOverlay() : memoOverlay);
  const {
    getPopupContainer,
    placement = "top",
    mouseEnterDelay = 0.1,
  ...
  const child = isValidElement(children) && !isFragment(children) ? children : React21.createElement("span", null, children);
  ...
  const [wrapSSR, hashId] = style_default(prefixCls, !injectFromPopover);
  const colorInfo = parseColor(prefixCls, color);
  const arrowContentStyle = colorInfo.arrowStyle;
  const formattedOverlayInnerStyle = Object.assign(Object.assign({}, overlayInnerStyle), colorInfo.overlayStyle);
  ...
  return wrapSSR(React21.createElement(es_default5, Object.assign({}, otherProps, {
    ...
    overlayInnerStyle: formattedOverlayInnerStyle,
    arrowContent: React21.createElement("span", {
...
var style_default2 = genComponentStyleHook("Typography", (token) => [genTypographyStyle(token)], () => ({
...
var Editable = (props) => {
  const {
    ...
    onEnd,
    component,
    enterIcon = React22.createElement(EnterOutlined_default, null)
  } = props;
  const ref = React22.useRef(null);
  const inComposition = React22.useRef(false);
  const lastKeyCode = React22.useRef();
  const [current, setCurrent] = React22.useState(value);
  React22.useEffect(() => {
    setCurrent(value);
  }, [value]);
  React22.useEffect(() => {
  ...
  return wrapSSR(React22.createElement("div", {
    className: textAreaClassName,
    style
  }, React22.createElement(TextArea_default, {
    ref,
    maxLength,
    value: current,
    onChange,
...
var Typography = React23.forwardRef((props, ref) => {
  const {
    prefixCls: customizePrefixCls,
    ...
    style
  } = props, restProps = __rest3(props, ["prefixCls", "component", "className", "rootClassName", "setContentRef", "children", "direction", "style"]);
  const {
    getPrefixCls,
  ...
  return wrapSSR(
    ...
    React23.createElement(Component, Object.assign({
...
var useUpdatedEffect = (callback, conditions) => {
  const mountRef = React25.useRef(false);
  React25.useEffect(() => {
    if (mountRef.current) {
      callback();
    } else {
...
var Ellipsis = (_ref) => {
  ...
  const [[startLen, midLen, endLen], setCutLength] = React26.useState([0, 0, 0]);
  const [lastLen, setLastLen] = React26.useState(0);
  const [walkingState, setWalkingState] = React26.useState(NONE);
  const [singleRowHeight, setSingleRowHeight] = React26.useState(0);
  const singleRowRef = React26.useRef(null);
  const midRowRef = React26.useRef(null);
  const nodeList = React26.useMemo(() => toArray(text), [text]);
  const totalLen = React26.useMemo(() => getNodesLen(nodeList), [nodeList]);
  const mergedChildren = React26.useMemo(() => {
  ...
  const renderMeasure = (content, ref, style) => React26.createElement("span", {
    "aria-hidden": true,
    ref,
    style: Object.assign({
      position: "fixed",
  ...
  return React26.createElement(React26.Fragment, null, mergedChildren, enabledMeasure && walkingState !== DONE_WITH_ELLIPSIS && walkingState !== DONE_WITHOUT_ELLIPSIS && React26.createElement(React26.Fragment, null, renderMeasure("lg", singleRowRef, {
    wordBreak: "keep-all",
    whiteSpace: "nowrap"
...
var EllipsisTooltip = (_ref) => {
  ...
  return React27.createElement(tooltip_default, Object.assign({
...
function wrapperDecorations(_ref, content) {
  ...
  function wrap(tag, needed) {
    ...
    currentContent = React28.createElement(tag, {}, currentContent);
  }
  wrap("strong", strong);
  wrap("u", underline);
  wrap("del", del);
...
var ELLIPSIS_STR = "...";
var Base = React28.forwardRef((props, ref) => {
  var _a, _b, _c;
  const {
    prefixCls: customizePrefixCls,
    className,
    ...
    component,
    title
  } = props, restProps = __rest4(props, ["prefixCls", "className", "style", "type", "disabled", "children", "ellipsis", "editable", "copyable", "component", "title"]);
  const {
    getPrefixCls,
    direction
  } = React28.useContext(ConfigContext);
  const [textLocale] = useLocale_default("Text");
  const typographyRef = React28.useRef(null);
  const editIconRef = React28.useRef(null);
  const prefixCls = getPrefixCls("typography", customizePrefixCls);
  ...
  const copyIdRef = React28.useRef(null);
  const copyOptions = {};
  ...
  React28.useEffect(() => cleanCopyId, []);
  const [isLineClampSupport, setIsLineClampSupport] = React28.useState(false);
  const [isTextOverflowSupport, setIsTextOverflowSupport] = React28.useState(false);
  const [expanded, setExpanded] = React28.useState(false);
  const [isJsEllipsis, setIsJsEllipsis] = React28.useState(false);
  const [isNativeEllipsis, setIsNativeEllipsis] = React28.useState(false);
  const [isNativeVisible, setIsNativeVisible] = React28.useState(true);
  ...
  const needMeasureEllipsis = React28.useMemo(() => (
    // Disable ellipsis
  ...
  const cssEllipsis = React28.useMemo(() => {
  ...
  const [ellipsisWidth, setEllipsisWidth] = React28.useState(0);
  const [ellipsisFontSize, setEllipsisFontSize] = React28.useState(0);
  ...
  } else if (React28.isValidElement(ellipsisConfig.tooltip)) {
    tooltipProps = {
  ...
  const topAriaLabel = React28.useMemo(() => {
  ...
  if (editing) {
    return React28.createElement(Editable_default, {
  ...
  const renderExpand = () => {
    ...
    return React28.createElement("a", {
      key: "expand",
  ...
  const renderEdit = () => {
    ...
    return triggerType.includes("icon") ? React28.createElement(tooltip_default, {
      key: "edit",
      title: tooltip === false ? "" : editTitle
    }, React28.createElement(transButton_default, {
      ref: editIconRef,
      className: `${prefixCls}-edit`,
      onClick: onEditClick,
      "aria-label": ariaLabel
    }, icon || React28.createElement(EditOutlined_default, {
      role: "button"
    }))) : null;
  };
  const renderCopy = () => {
    ...
    return React28.createElement(tooltip_default, {
      key: "copy",
      title: copyTitle
    }, React28.createElement(transButton_default, {
      className: (0, import_classnames11.default)(`${prefixCls}-copy`, copied && `${prefixCls}-copy-success`),
      onClick: onCopyClick,
      "aria-label": ariaLabel
    }, copied ? getNode(iconNodes[1], React28.createElement(CheckOutlined_default, null), true) : getNode(iconNodes[0], React28.createElement(CopyOutlined_default, null), true)));
  };
  const renderOperations = (renderExpanded) => [renderExpanded && renderExpand(), renderEdit(), renderCopy()];
  const renderEllipsis = (needEllipsis) => [needEllipsis && React28.createElement("span", {
    "aria-hidden": true,
    key: "ellipsis"
  }, ELLIPSIS_STR), ellipsisConfig.suffix, renderOperations(needEllipsis)];
  return React28.createElement(es_default, {
    onResize,
    disabled: !mergedEnableEllipsis || cssEllipsis
  }, (resizeRef) => React28.createElement(EllipsisTooltip_default, {
    tooltipProps,
    enabledEllipsis: mergedEnableEllipsis,
    isEllipsis: isMergedEllipsis
  }, React28.createElement(Typography_default, Object.assign({
    ...
    title
  }, textProps), React28.createElement(Ellipsis_default, {
    ...
    if (node.length && needEllipsis && topAriaLabel) {
      renderNode = React28.createElement("span", {
        key: "show-content",
        "aria-hidden": true
      }, renderNode);
    }
    const wrappedContext = wrapperDecorations(props, React28.createElement(React28.Fragment, null, renderNode, renderEllipsis(needEllipsis)));
...
var Link = React29.forwardRef((_a, ref) => {
  var {
    ellipsis,
    rel
  } = _a, restProps = __rest5(_a, ["ellipsis", "rel"]);
  if (true) {
  ...
  return React29.createElement(Base_default, Object.assign({}, mergedProps, {
    ref,
    ellipsis: !!ellipsis,
    component: "a"
  }));
...
//# sourceMappingURL=chunk-Q6YFJQHN.js.map
